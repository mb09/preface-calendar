...
class TimeslotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timeslot" do
    assert_difference('Timeslot.count') do
      post timeslots_url, params: { timeslot: { dow: @timeslot.dow, footnote: @timeslot.footnote, start_time: @timeslot.start_time, state: @timeslot.state, teacher: @timeslot.teacher } }
    end
  ...
  test "should update timeslot" do
    patch timeslot_url(@timeslot), params: { timeslot: { dow: @timeslot.dow, footnote: @timeslot.footnote, start_time: @timeslot.start_time, state: @timeslot.state, teacher: @timeslot.teacher } }
